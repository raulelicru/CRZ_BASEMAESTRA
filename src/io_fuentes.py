...
ESQUEMA_FUENTES: dict[str, list[str]] = {
    ...
    "CARTERA_MORA": [
        "NO_DAMA", "CAMPANA_SALDO", "ZONA", "ID_SITUACION", "DESC_SITUACION",
        "ID_SITUACION_CIE", "DESC_SITUACION_CIE", "TIPO_NOMBRAMIENTO",
        "GEOLOCALIZACION", "NUMERO_LIQUIDACION", "PRECIERRE_1", "PRECIERRE_2",
        "REACTIVACION", "CANCELACION", "PRIMERA_ORDEN",
    ],
    "LAYOUT_ARABELA": [
