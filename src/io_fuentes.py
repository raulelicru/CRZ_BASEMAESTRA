...
ESQUEMA_FUENTES: dict[str, list[str]] = {
    "CARTERA_INACTIVAS": [
        "NO_DAMA", "ID_COBRADOR", "ZONA", "CAMPANA_SALDO", "FECHA_FACTURA",
    ...
    "CARTERA_MORA": [
        "NO_DAMA", "CAMPANA_SALDO", "ZONA", "DIGITO_DAMA", "NOMBRE",
        "SEGMENTO", "ESTADO_PROCESO", "SALDO_DAMA", "DOMICILIO", "COLONIA",
        "CODIGO_POSTAL", "POBLACION", "ESTADO", "TELEFONO_CASA", "TELEFONO_CELULAR",
...
SINONIMOS = {
    ...
    "CALLE": ["CALLE"],
    "DOMICILIO": ["DOMICILIO", "DIRECCION", "DOMICILIOCOMPLETO", "DIRECCIONCOMPLETA"],
    ...
    # Mapeo ARABELA Junio: STATUS_GESTION <- "Tipo de Gestion"
    "STATUS_GESTION": ["TIPODEGESTION", "TIPOGESTION", "STATUSGESTION"],
    # MOTIVO_NO_COBRO <- "Estatus"
    "MOTIVO_NO_COBRO": ["ESTATUS", "MOTIVONOCOBRO", "MOTIVO"],
    # DICTAMINACION <- "Tipificacion"
    "DICTAMINACION": ["TIPIFICACION", "TIPIFICACILON", "DICTAMINACION", "DICTAMEN"],
    # COMENTARIO <- "Comentario"
    "COMENTARIO": ["COMENTARIO", "COMENTARIOS", "OBSERVACION", "OBSERVACIONES"],
